  ...
  return (
    <div className='bg-gray-800 text-white'>
      <div >
        ...
        <h3 className='pt-16 text-center text-3xl max-w-2/3 md:max-w-1/3 m-auto'>付款後請連截圖轉賬憑據並傳送至本店Whatsapp客服</h3>
        <h3 className='py-16 text-center text-3xl max-w-2/3 md:max-w-1/3 m-auto'>PayPal(+5%)行政費，Fps/Alipayhk/Payme(+0%)</h3>
      </div>
